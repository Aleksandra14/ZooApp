...
public abstract class Classifier {
  ...
  protected Classifier(Activity activity, Device device, int numThreads) throws IOException {
    tfliteModel = FileUtil.loadMappedFile(activity, getModelPath()); //ubacivanje fajla modela
    switch (device) {
      case NNAPI:
    ...
    tflite = new Interpreter(tfliteModel, tfliteOptions); //instanciranje interpretera

    // Loads labels out from the label file.
    labels = FileUtil.loadLabels(activity, getLabelPath()); //učitavanje liste labela
